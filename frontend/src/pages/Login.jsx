...
import { Lock, Mail, ChevronLeft, Home } from "lucide-react";
...
export default function Login() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `linear-gradient(to bottom, rgba(2,6,23,0.9), rgba(2,6,23,0.95)), url(https://images.unsplash.com/photo-1526403221243-7494a1c1a150?auto=format&fit=crop&w=1800&q=80)`,
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl  font-['Barlow_Condensed'] uppercase tracking-tight">
              Aerial Intelligence: The Drone as First Responder (DRF)
            </h1>
